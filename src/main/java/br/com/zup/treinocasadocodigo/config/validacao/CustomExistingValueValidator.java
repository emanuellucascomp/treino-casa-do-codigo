...
public class CustomExistingValueValidator implements ConstraintValidator<CustomExistingValue, Object> {
	...
	@Override
	public void initialize(CustomExistingValue constraintAnnotation) {
